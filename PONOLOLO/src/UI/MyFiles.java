...
public class MyFiles extends JFrame {
	...
	public MyFiles(String path , String Owner) {
		...
		btnNewButton.setBounds(930, 32, 130, 23);
		contentPane.add(btnNewButton);
		
		textField = new JTextField();
		textField.setBounds(194, 32, 726, 23);
		...
		btnNewButton_1.setBounds(930, 596, 130, 23);
		...
		btnNewButton_2.setBounds(790, 596, 130, 23);
		...
		btnNewButton_2_1.setBounds(26, 596, 130, 23);
		...
		btnNewButton_2_2.setBounds(26, 562, 130, 23);
		contentPane.add(btnNewButton_2_2);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(194, 65, 866, 526);
		...
		btnNewButton_2_3_1.setBounds(649, 596, 130, 23);
